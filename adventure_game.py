...
def incipit(prev_event=cathedral_visited):
    ...
    if prev_event is False:
        ...
        print("\nYou trace your steps back to the spot where you first"
              ...
              "the only way now is towards the voices. And so you head off...")
        voices()
...
def cathedral():
    ...
    if event == 'cathedral_a':
        print("\nJust as you thought your existence was coming to an end, "
              "the quake-like shaking stops, as suddenly as it had started. "
              "But something is different...")
        time.sleep(5)
        print("\nThe golden cathedral has disappeared. "
              "A small golden object lies on the ground where it once stood.")
        time.sleep(5)
        ...
        print("\nA deep, yawning chasm embraces you, engulfs you, "
              ...
              "of this conscious existence, the image of a golden platypus "
